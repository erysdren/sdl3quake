...
if(NOT DEFINED WAMR_BUILD_PLATFORM)
	string(TOLOWER ${CMAKE_SYSTEM_NAME} WAMR_BUILD_PLATFORM_DEFAULT)
	set(WAMR_BUILD_PLATFORM ${WAMR_BUILD_PLATFORM_DEFAULT} CACHE STRING "WAMR target platform")
	set_property(CACHE WAMR_BUILD_PLATFORM PROPERTY STRINGS
		alios android cosmopolitan darwin ego esp-idf freebsd linux linux-sgx
		nuttx riot rt-thread vxworks windows zephyr
	)
endif()
if(NOT DEFINED WAMR_BUILD_TARGET)
	if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(arm64|aarch64)")
		set(WAMR_BUILD_TARGET_DEFAULT "AARCH64")
	elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "riscv64")
		set(WAMR_BUILD_TARGET_DEFAULT "RISCV64")
	elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^(riscv)")
		set(WAMR_BUILD_TARGET_DEFAULT "RISCV")
	elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
		set(WAMR_BUILD_TARGET_DEFAULT "X86_64")
	elseif (CMAKE_SIZEOF_VOID_P EQUAL 4)
		set(WAMR_BUILD_TARGET_DEFAULT "X86_32")
	endif()
	set(WAMR_BUILD_TARGET ${WAMR_BUILD_TARGET_DEFAULT} CACHE STRING "WAMR target architechture")
	set_property(CACHE WAMR_BUILD_TARGET PROPERTY STRINGS
		X86_64 AMD_64 X86_32 AARCH64 ARM THUMB MIPS XTENSA RISCV
	)
endif()
...
set(WAMR_ROOT_DIR ${PROJECT_SOURCE_DIR}/src/wasm-micro-runtime)
